...
$email_envio = 'stefany.vasc.sa@gmail.com'; // E-mail receptor
$email_pass = 'stevasc03'; // Senha do e-mail

$site_name = 'competent-policy'; // Nome do Site
$site_url = 'competent-policy.000webhostapp.com'; // URL do Site
